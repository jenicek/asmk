...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "hamming",
        "sources": [
            "/home/tomas/workspace/phd/code/public/asmk/cython/hamming.pyx"
        ]
    },
    "module_name": "hamming"
}
...
static unsigned int __pyx_f_7hamming_c_binarize_and_pack_uint32(__Pyx_memviewslice, Py_ssize_t, int); /*proto*/
static float __pyx_f_7hamming_c_hamming_dist_uint32_arr(__Pyx_memviewslice, __Pyx_memviewslice, float); /*proto*/
...
static PyObject *__pyx_pf_7hamming_binarize_and_pack(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr, int __pyx_v_threshold); /* proto */
static PyObject *__pyx_pf_7hamming_2binarize_and_pack_2D(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr, int __pyx_v_threshold); /* proto */
static PyObject *__pyx_pf_7hamming_4hamming_dist_packed(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_n1, __Pyx_memviewslice __pyx_v_n2, float __pyx_v_normalization); /* proto */
static PyObject *__pyx_pf_7hamming_6hamming_cdist_packed(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr1, __Pyx_memviewslice __pyx_v_arr2, float __pyx_v_normalization); /* proto */
...
static unsigned int __pyx_f_7hamming_c_binarize_and_pack_uint32(__Pyx_memviewslice __pyx_v_arr, Py_ssize_t __pyx_v_length, int __pyx_v_threshold) {
...
static float __pyx_f_7hamming_c_hamming_dist_uint32_arr(__Pyx_memviewslice __pyx_v_n1, __Pyx_memviewslice __pyx_v_n2, float __pyx_v_normalization) {
...
/* Python wrapper */
static PyObject *__pyx_pw_7hamming_1binarize_and_pack(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7hamming_binarize_and_pack[] = "\n    binarize_and_pack(float[::1] arr, int threshold = 0)\n\n    Binarizes given 1D numpy array by 'arr = arr > threshold' and packs its elements into bits\n    in uint32 array. Returns a 1D uint32 array where each element corresponds to a started set\n    of 32 bits.\n\n    >> binarize_and_pack((np.random.rand(10) - 0.5).astype(np.float32))\n    array([2206203904], dtype=uint32)\n    ";
static PyMethodDef __pyx_mdef_7hamming_1binarize_and_pack = {"binarize_and_pack", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7hamming_1binarize_and_pack, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7hamming_binarize_and_pack};
static PyObject *__pyx_pw_7hamming_1binarize_and_pack(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("binarize_and_pack (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "binarize_and_pack") < 0)) __PYX_ERR(0, 49, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_arr = __Pyx_PyObject_to_MemoryviewSlice_dc_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_arr.memview)) __PYX_ERR(0, 49, __pyx_L3_error)
    if (values[1]) {
      __pyx_v_threshold = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_threshold == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("binarize_and_pack", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 49, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hamming.binarize_and_pack", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7hamming_binarize_and_pack(__pyx_self, __pyx_v_arr, __pyx_v_threshold);
...
static PyObject *__pyx_pf_7hamming_binarize_and_pack(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr, int __pyx_v_threshold) {
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_dim); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_int(__pyx_v_result, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 63, __pyx_L1_error)
...
__pyx_t_12 = __pyx_v_i;
    *((unsigned int *) ( /* dim=0 */ ((char *) (((unsigned int *) __pyx_v_result_view.data) + __pyx_t_12)) )) = __pyx_f_7hamming_c_binarize_and_pack_uint32(__pyx_t_10, 32, __pyx_v_threshold);
...
__pyx_v_tmp = __pyx_f_7hamming_c_binarize_and_pack_uint32(__pyx_t_10, (__pyx_v_dim_orig - __pyx_v_offset), __pyx_v_threshold);
  __PYX_XDEC_MEMVIEW(&__pyx_t_10, 1);
  __pyx_t_10.memview = NULL;
  __pyx_t_10.data = NULL;
...
/* Python wrapper */
static PyObject *__pyx_pw_7hamming_3binarize_and_pack_2D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7hamming_2binarize_and_pack_2D[] = "\n    binarize_and_pack_2D(float[:,::1] arr, int threshold = 0)\n\n    Binarizes given 2D numpy array by 'arr = arr > threshold' and packs its elements into bits\n    in uint32 array. Returns a 2D uint32 array where each row corresponds to row in the original\n    array and each element to a started set of 32 bits.\n\n    >> binarize_and_pack_2D((np.random.rand(2, 10) - 0.5).astype(np.float32))\n    array([[1786773504]\n           [1509949440]], dtype=uint32)\n    ";
static PyMethodDef __pyx_mdef_7hamming_3binarize_and_pack_2D = {"binarize_and_pack_2D", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7hamming_3binarize_and_pack_2D, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7hamming_2binarize_and_pack_2D};
static PyObject *__pyx_pw_7hamming_3binarize_and_pack_2D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_arr = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_threshold;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  __Pyx_RefNannySetupContext("binarize_and_pack_2D (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "binarize_and_pack_2D") < 0)) __PYX_ERR(0, 79, __pyx_L3_error)
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  2: values[1] = PyTuple_GET_ITEM(__pyx_args, 1);
    ...
    __pyx_v_arr = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_arr.memview)) __PYX_ERR(0, 79, __pyx_L3_error)
    if (values[1]) {
      __pyx_v_threshold = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_threshold == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 79, __pyx_L3_error)
    } else {
      __pyx_v_threshold = ((int)0);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("binarize_and_pack_2D", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 79, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hamming.binarize_and_pack_2D", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7hamming_2binarize_and_pack_2D(__pyx_self, __pyx_v_arr, __pyx_v_threshold);
...
static PyObject *__pyx_pf_7hamming_2binarize_and_pack_2D(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr, int __pyx_v_threshold) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_dim0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_dim1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_uint32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_int(__pyx_v_result, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 95, __pyx_L1_error)
  __pyx_v_result_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;
...
__pyx_t_15 = __pyx_v_i;
      ...
      *((unsigned int *) ( /* dim=1 */ ((char *) (((unsigned int *) ( /* dim=0 */ (__pyx_v_result_view.data + __pyx_t_15 * __pyx_v_result_view.strides[0]) )) + __pyx_t_16)) )) = __pyx_f_7hamming_c_binarize_and_pack_uint32(__pyx_t_13, 32, __pyx_v_threshold);
...
__pyx_v_tmp = __pyx_f_7hamming_c_binarize_and_pack_uint32(__pyx_t_13, (__pyx_v_dim1_orig - __pyx_v_offset), __pyx_v_threshold);
    __PYX_XDEC_MEMVIEW(&__pyx_t_13, 1);
    __pyx_t_13.memview = NULL;
    __pyx_t_13.data = NULL;
...
/* Python wrapper */
static PyObject *__pyx_pw_7hamming_5hamming_dist_packed(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7hamming_4hamming_dist_packed[] = "\n    hamming_dist_packed(unsigned int[::1] n1, unsigned int[::1] n2, float normalization = 0)\n\n    Computes a hamming distance between two bit arrays packed into uint32 arrays and divides\n    it by normalization, if provided, otherwise by the number of bits in an array (always\n    a multiplication of 32).\n\n    >> hamming_dist_packed(np.array([3], dtype=np.uint32), np.array([1], dtype=np.uint32), 2)\n    0.5\n    ";
static PyMethodDef __pyx_mdef_7hamming_5hamming_dist_packed = {"hamming_dist_packed", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7hamming_5hamming_dist_packed, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7hamming_4hamming_dist_packed};
static PyObject *__pyx_pw_7hamming_5hamming_dist_packed(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("hamming_dist_packed (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("hamming_dist_packed", 0, 2, 3, 1); __PYX_ERR(0, 112, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "hamming_dist_packed") < 0)) __PYX_ERR(0, 112, __pyx_L3_error)
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  3: values[2] = PyTuple_GET_ITEM(__pyx_args, 2);
    ...
    __pyx_v_n1 = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_n1.memview)) __PYX_ERR(0, 112, __pyx_L3_error)
    __pyx_v_n2 = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_n2.memview)) __PYX_ERR(0, 112, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_normalization = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_normalization == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 112, __pyx_L3_error)
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("hamming_dist_packed", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 112, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hamming.hamming_dist_packed", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7hamming_4hamming_dist_packed(__pyx_self, __pyx_v_n1, __pyx_v_n2, __pyx_v_normalization);
...
static PyObject *__pyx_pf_7hamming_4hamming_dist_packed(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_n1, __Pyx_memviewslice __pyx_v_n2, float __pyx_v_normalization) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = PyFloat_FromDouble(__pyx_f_7hamming_c_hamming_dist_uint32_arr(__pyx_v_n1, __pyx_v_n2, __pyx_v_normalization)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 125, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_7hamming_7hamming_cdist_packed(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7hamming_6hamming_cdist_packed[] = "\n    hamming_cdist_packed(unsigned int[:,::1] arr1, unsigned int[:,::1] arr2, float normalization = 0)\n\n    Computes a hamming distance between two sets of bit arrays packed into uint32 using\n    hamming_dist_packed. Returns an array of size (arr1.shape[0], arr2.shape[0]).\n\n    >> hamming_cdist_packed(np.array([[3], [1]], dtype=np.uint32), np.array([[1], [2]], dtype=np.uint32), 2)\n    array([[0.5, 0.5],\n           [0. , 1. ]], dtype=float32)\n    ";
static PyMethodDef __pyx_mdef_7hamming_7hamming_cdist_packed = {"hamming_cdist_packed", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7hamming_7hamming_cdist_packed, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7hamming_6hamming_cdist_packed};
static PyObject *__pyx_pw_7hamming_7hamming_cdist_packed(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("hamming_cdist_packed (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_arr2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("hamming_cdist_packed", 0, 2, 3, 1); __PYX_ERR(0, 128, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "hamming_cdist_packed") < 0)) __PYX_ERR(0, 128, __pyx_L3_error)
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  3: values[2] = PyTuple_GET_ITEM(__pyx_args, 2);
    ...
    __pyx_v_arr1 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_arr1.memview)) __PYX_ERR(0, 128, __pyx_L3_error)
    __pyx_v_arr2 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_arr2.memview)) __PYX_ERR(0, 128, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_normalization = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_normalization == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 128, __pyx_L3_error)
    } else {
      __pyx_v_normalization = ((float)0.0);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("hamming_cdist_packed", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 128, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hamming.hamming_cdist_packed", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7hamming_6hamming_cdist_packed(__pyx_self, __pyx_v_arr1, __pyx_v_arr2, __pyx_v_normalization);
...
static PyObject *__pyx_pf_7hamming_6hamming_cdist_packed(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr1, __Pyx_memviewslice __pyx_v_arr2, float __pyx_v_normalization) {
  Py_ssize_t __pyx_v_dim0;
  Py_ssize_t __pyx_v_dim1;
  PyObject *__pyx_v_result = NULL;
  __Pyx_memviewslice __pyx_v_result_view = { 0, 0, { 0 }, { 0 }, { 0 } };
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_dim0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 144, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_dim1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 144, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 144, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_float32); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 144, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_7) < 0) __PYX_ERR(0, 144, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, __pyx_t_6); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 144, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *     cdef Py_ssize_t i, j
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(__pyx_v_result, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 145, __pyx_L1_error)
...
__pyx_t_17 = __pyx_v_i;
      ...
      *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_result_view.data + __pyx_t_17 * __pyx_v_result_view.strides[0]) )) + __pyx_t_18)) )) = __pyx_f_7hamming_c_hamming_dist_uint32_arr(__pyx_t_15, __pyx_t_16, __pyx_v_normalization);
 ...
 *     binarize_and_pack(float[::1] arr, int threshold = 0)
 */
  __pyx_tuple__19 = PyTuple_Pack(9, __pyx_n_s_arr, __pyx_n_s_threshold, __pyx_n_s_dim_orig, __pyx_n_s_dim, __pyx_n_s_result, __pyx_n_s_result_view, __pyx_n_s_i, __pyx_n_s_offset, __pyx_n_s_tmp); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(2, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_hamming_pyx, __pyx_n_s_binarize_and_pack, 49, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 49, __pyx_L1_error)
 ...
 *     binarize_and_pack_2D(float[:,::1] arr, int threshold = 0)
 */
  __pyx_tuple__21 = PyTuple_Pack(11, __pyx_n_s_arr, __pyx_n_s_threshold, __pyx_n_s_dim0, __pyx_n_s_dim1_orig, __pyx_n_s_dim1, __pyx_n_s_result, __pyx_n_s_result_view, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_offset, __pyx_n_s_tmp); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(2, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_hamming_pyx, __pyx_n_s_binarize_and_pack_2D, 79, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 79, __pyx_L1_error)
 ...
 *     hamming_dist_packed(unsigned int[::1] n1, unsigned int[::1] n2, float normalization = 0)
 */
  __pyx_tuple__23 = PyTuple_Pack(3, __pyx_n_s_n1, __pyx_n_s_n2, __pyx_n_s_normalization); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__23);
  __Pyx_GIVEREF(__pyx_tuple__23);
  __pyx_codeobj__24 = (PyObject*)__Pyx_PyCode_New(3, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__23, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_hamming_pyx, __pyx_n_s_hamming_dist_packed, 112, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__24)) __PYX_ERR(0, 112, __pyx_L1_error)
 ...
 *     hamming_cdist_packed(unsigned int[:,::1] arr1, unsigned int[:,::1] arr2, float normalization = 0)
 */
  __pyx_tuple__25 = PyTuple_Pack(9, __pyx_n_s_arr1, __pyx_n_s_arr2, __pyx_n_s_normalization, __pyx_n_s_dim0, __pyx_n_s_dim1, __pyx_n_s_result, __pyx_n_s_result_view, __pyx_n_s_i, __pyx_n_s_j); if (unlikely(!__pyx_tuple__25)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__25);
  __Pyx_GIVEREF(__pyx_tuple__25);
  __pyx_codeobj__26 = (PyObject*)__Pyx_PyCode_New(3, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__25, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_hamming_pyx, __pyx_n_s_hamming_cdist_packed, 128, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__26)) __PYX_ERR(0, 128, __pyx_L1_error)
 ...
 *     binarize_and_pack(float[::1] arr, int threshold = 0)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7hamming_1binarize_and_pack, NULL, __pyx_n_s_hamming); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_binarize_and_pack, __pyx_t_1) < 0) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     binarize_and_pack_2D(float[:,::1] arr, int threshold = 0)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7hamming_3binarize_and_pack_2D, NULL, __pyx_n_s_hamming); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_binarize_and_pack_2D, __pyx_t_1) < 0) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     hamming_dist_packed(unsigned int[::1] n1, unsigned int[::1] n2, float normalization = 0)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7hamming_5hamming_dist_packed, NULL, __pyx_n_s_hamming); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_hamming_dist_packed, __pyx_t_1) < 0) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     hamming_cdist_packed(unsigned int[:,::1] arr1, unsigned int[:,::1] arr2, float normalization = 0)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7hamming_7hamming_cdist_packed, NULL, __pyx_n_s_hamming); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_hamming_cdist_packed, __pyx_t_1) < 0) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
